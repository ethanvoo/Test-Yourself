...
class AskQuestionsFrame:
    def __init__(self, main_frame, displayed_topics: list, selected_topics: list):
        ...
        self.title = ctk.CTkLabel(self.question_frame, text=f'Questions on {selected_topics_str}', width=30, height=28, fg_color='transparent', font=("Calibre", 23))
